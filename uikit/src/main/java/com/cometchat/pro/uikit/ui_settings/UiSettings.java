...
public class UiSettings {
    ...
    protected static boolean showCallsBB = false;
    ...
    protected static boolean enableVideoCalling = false;
    protected static boolean enableVoiceCalling = false;
    ...
    public static boolean isStickerVisible() {
        return sendStickers;
    }
    ...
    public static boolean isTranslationAllowed() {
